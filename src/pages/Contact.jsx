          ...
          <div style={{
            ...
            {sent ? (
              <div style={{ textAlign: 'center', padding: '2rem 0' }}>
                <div style={{ display:'flex', justifyContent:'center', marginBottom: '1rem', animation: 'float 3s ease-in-out infinite' }}>
                  <div style={{ width:72, height:72, borderRadius:'50%', background:'rgba(16,185,129,0.14)', border:'1px solid rgba(16,185,129,0.3)', display:'flex', alignItems:'center', justifyContent:'center' }}>
                    <IconCheckCircle size={34} color="#34d399" />
                  </div>
                </div>
