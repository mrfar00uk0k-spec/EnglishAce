    ...
    <div style={{ background:'rgb(6,10,22)', color:'#fff', minHeight:'100vh', paddingBottom:'4rem', paddingTop: 68 }}>
      ...
      <div style={{
        ...
        <h1 style={{ fontSize:'clamp(1.8rem,5vw,2.8rem)', fontWeight:900, fontFamily:'Playfair Display,serif', marginBottom:'0.5rem' }}>
          {singleTest
            ? (isAr ? 'نتائج الاختبار' : `Your ${completedSections[0] ? (isAr ? completedSections[0].labelAr : completedSections[0].label) : ''} Results`)
      ...
      {/* ── SCORE BARS ── */}
        {completedSections.length > 1 && !singleTest && (
      ...
      <style>{`
        @media print {
          * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
          ...
          .results-mini-cards,
          [class*="lv-"],
          [style*="bottom: 20px"] { display:none !important; }
          .print-card { 
