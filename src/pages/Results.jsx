...
// CIRCLE SCORE (SVG)
// ─────────────────────────────────────────────────────────────────────────────
// Fix: ring-only SVG (no baked-in text) — matches AssessmentFeedback.jsx's ScoreRing exactly,
// so every individual test result AND the full-suite results screen share the identical circle style.
  ...
  return (
    ...
    <div className="no-print" style={{ background:'rgb(6,10,22)', color:'#fff', minHeight:'100vh', paddingBottom:'5rem', paddingTop:68 }}>
      ...
      <div style={{
        ...
        {/* Big circle — Fix: number rendered as a crisp HTML overlay centered on the ring, matching every individual test's result screen exactly */}
        <Reveal delay={250}>
          <div style={{ display:'flex', justifyContent:'center', marginBottom:'2rem', position:'relative' }}>
            <div style={{ position:'relative', display:'inline-block' }}>
              ...
              <div style={{ position:'absolute', inset:0, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', textAlign:'center', pointerEvents:'none' }}>
                <div style={{ fontSize:'3.2rem', fontWeight:900, color:totalColor, lineHeight:1 }}>
                  {displayedScore}
                </div>
          ...
          >
            ...
            <div style={{ marginTop:'1.75rem', paddingTop:'1.25rem', borderTop:'1px solid rgba(255,255,255,0.06)', display:'flex', alignItems:'center', justifyContent:'center', gap:8, position:'relative', zIndex:1 }}>
              ...
              <span style={{ color:'rgba(255,255,255,0.18)', fontSize:'0.64rem', letterSpacing:'0.15em', textTransform:'uppercase' }}>
                {typeof window !== "undefined" ? window.location.hostname : "englishace.io"} · Powered by AI
              </span>
            </div>
          </div>
        </Reveal>
