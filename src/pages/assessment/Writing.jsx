...
export default function Writing({ onFinish, isSingle }) {
  ...
  useEffect(() => { resetLexi() /* eslint-disable-line react-hooks/exhaustive-deps */ }, [])
      ...
      {phase === 'writing' && (
        <div>
          <textarea
            ...
            onPaste={handlePaste}
            onDrop={e => { e.preventDefault(); setPasteBlocked(true); setTimeout(() => setPasteBlocked(false), 3500) }}
          ...
          />
          {pasteBlocked && (
            <div style={{ marginTop: 8, padding: '9px 13px', background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.3)', borderRadius: 8, color: '#fca5a5', fontSize: '0.83rem', display: 'flex', alignItems: 'center', gap: 8 }}>
              ⚠️ Pasting is disabled. Please type your answer to get an accurate result.
            </div>
          )}
