  ...
  return (
    <div style={{ paddingTop: 68, background: 'rgb(6,10,22)', minHeight: '100vh', color: '#fff', paddingTop: 68 }}>
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '4rem 1.5rem' }}>
        ...
        <div style={{ background: 'rgba(16,185,129,0.08)', border: '1px solid rgba(16,185,129,0.2)', borderRadius: 12, padding: '1rem 1.25rem', marginBottom: '2.5rem' }}>
          <p style={{ color: '#6ee7b7', fontWeight: 600, fontSize: '0.9rem' }}>
