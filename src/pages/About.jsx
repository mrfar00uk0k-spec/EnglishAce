...
// ── Founder/Team photo — replace with your own photo ───────────────────────
// Place your photo as public/founder.jpg and update the path below
const DEVELOPER_PHOTO = '/founder.jpg'   // ← change this path to use your own photo
        ...
        <div style={{ maxWidth: 480, margin: '0 auto', textAlign: 'center' }}>
          ...
          <Link to="/contact" style={{ display: 'block', textDecoration: 'none' }}>
            <GlowCard borderRadius={20} style={{
              ...
              <div style={{ color: '#fff', fontWeight: 800, fontSize: '1.2rem', marginBottom: 6 }}>Your Name Here</div>
