      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(180px,1fr))', gap: '2rem', marginBottom: '2.5rem' }}>
          ...
          <div>
            ...
            <a href="https://www.facebook.com/yourpage" style={{ display:'block', color:'rgba(255,255,255,0.42)', fontSize:'0.84rem', marginBottom:4 }}>Facebook</a>
            <a href="https://wa.me/10000000000" target="_blank" rel="noreferrer" style={{ display:'block', color:'rgba(255,255,255,0.42)', fontSize:'0.84rem' }}>+1 (000) 000-0000</a>
          </div>
        </div>
