    ...
    <>
      <nav className="no-print" style={{
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: 'auto 1fr auto', alignItems: 'center', height: 66, paddingLeft: '1.25rem', paddingRight: '1.25rem', gap: '0' }}>
          ...
          {/* Logo */}
          {/* Logo + Lexi badge side by side, using normal flex flow so the
              badge always sits right after the logo in reading order —
              in RTL this naturally mirrors to the logo's other side, with
              no hardcoded pixel offset that could drift out of sync with
              the logo's actual rendered width and overlap it. */}
          <div
          ...
          >
            ...
            {/* Lexi mini badge — a normal flex sibling of the logo, not absolutely positioned */}
         {location.pathname === '/' && (
  <div
