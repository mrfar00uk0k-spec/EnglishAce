    ...
    <>
      <nav className="no-print" style={{
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: 'auto 1fr auto', alignItems: 'center', height: 66, paddingLeft: '1.25rem', paddingRight: '1.25rem', gap: '0' }}>
          ...
          {/* Logo */}
          {/* Logo + Lexi badge side by side. This group is locked to LTR
              internally (direction:'ltr' below) so the badge always sits in
              the exact same spot relative to the logo — icon, then name,
              then badge — regardless of site language. Only the group's
              placement within the outer nav grid still mirrors for RTL, the
              same as the rest of the navbar; nothing inside it re-jumbles. */}
          <div
          ...
          >
            ...
            {/* Lexi mini badge — always icon-then-text, same spot every time, in either language */}
         {location.pathname === '/' && (
  <div
