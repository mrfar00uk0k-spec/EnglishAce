  ...
  return (
    <>
      <nav className="no-print" style={{
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns:'350px 1fr auto', alignItems: 'center', height: 66, paddingLeft: '1.25rem', paddingRight: '1.25rem', gap: '0' }}>
  ...
  >
    ...
    >
      {greeting.text}
          ...
          {/* Desktop Links */}
          <div className="nav-desktop" style={{ marginLeft: '50px',display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1.6rem',marginLeft: '-120px', }}>
            {links.map(l => (
              <a
                key={l.to}
                href={l.to}
